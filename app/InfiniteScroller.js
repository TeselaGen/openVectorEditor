...
module.exports = React.createClass({
    propTypes: {
        ...
        preloadRowStart: React.PropTypes.number,
  ...
  componentWillMount: function (argument) {
    ...
    this.prepareVisibleRows(this.props.preloadRowStart, 4);
  },
  ...
  prepareVisibleRows: function (rowStart, newNumberOfRowsToDisplay) { //note, rowEnd is optional
    if (rowStart + newNumberOfRowsToDisplay > this.props.rowData.length) {
      this.rowEnd = this.props.rowData.length - 1;
    } else {
    ...
    //   console.log('this.rowEnd', this.rowEnd);
      this.setState({
        visibleRows: this.props.rowData.slice(this.rowStart,this.rowEnd+1)
      });
    // } else {
