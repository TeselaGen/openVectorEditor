...
function SelectionLayer ({selectionLayer, sequenceLength, radius, innerRadius}) {
    //console.log('RENDERING SELECTION LAYER');
    ...
    return <g key='veSelectionLayer' className='veSelectionLayer'>
