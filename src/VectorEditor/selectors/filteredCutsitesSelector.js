...
export default createSelector(cutsitesSelector, filteredRestrictionEnzymesSelector, function ({cutsitesByName}, filteredRestrictionEnzymes) {
  var returnVal = {
    cutsitesByName:{}
  }
  ...
  returnVal.cutsitesArray = flatmap(returnVal.cutsitesByName, (cutsitesByNameArray)=>cutsitesByNameArray)
