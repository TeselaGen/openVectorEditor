...
function DeletionLayers(props) {
    var {radius, sequenceLength, deletionLayers={}, annotationHeight, deletionLayerClicked} = props
    ...
    var component = <g
      ...
      className='veDeletionLayers'>
      {
        map(deletionLayers,function (deletionLayer, index) {
          ...
          var {startAngle, endAngle, totalAngle} = getRangeAngles(deletionLayer, sequenceLength);
