...
function FeatureToolDropDown({ dispatch, readOnly, editorName, selectionLayer, annotationLabelVisibility, annotationLabelVisibilityToggle }) {
  return (
    <div style={{paddingTop: 5}}>
      <Checkbox onChange={function() {
        ...
        checked={annotationLabelVisibility.features} label={"Show feature labels"}>
      </Checkbox>
