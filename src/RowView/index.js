...
import _ReactList from "@teselagen/react-list";
    ...
    getNearestCursorPositionToMouseEvent = (rowData, event, callback) => {
      ...
      some(visibleRowsContainer.childNodes, function (rowDomNode) {
        ...
        if (
          ...
          rowNotFound = false;
          const row =
            rowData[Number(rowDomNode.getAttribute("data-row-number"))];
    ...
    updateScrollPosition = (oldProps, newProps) => {
      ...
      if (
        ...
        ((matchedSearchLayer.forceUpdate &&
          matchedSearchLayer.forceUpdate !==
            matchedSearchLayerOld.forceUpdate) ||
