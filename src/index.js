...
//export components
export { default as CircularView, CircularView as CircularViewUnconnected } from "./CircularView";
...
export { default as VeToolBar, VeToolBar as VeToolBarUnconnected } from "./VeToolBar";
