...
function AASliver(props) {
  ...
  let dirX1 = 1 / Math.sqrt(26);
  let dirY1 = 5 * dirX1;

  let dirX2 = 16 / Math.sqrt(2756) ;
  let dirY2 = 50 / Math.sqrt(2756);

  let roundedCorner = 15;
  let path = '';
  path = isFiller
                ...
                ? `M ${roundedCorner / 3}, 0
                  ...
                  Q 60 50 ${60 - roundedCorner * dirX1} ${50 + roundedCorner * dirY1}
                  L ${50 + roundedCorner * dirX1}, ${100 - roundedCorner * dirY1}
                  Q 50 100 ${50 - roundedCorner} 100
                  L ${roundedCorner / 3}, 100
                  Q 0 100 ${roundedCorner * dirX2} ${100 - roundedCorner * dirY2}
                  L ${16 - roundedCorner * dirX2}, ${50 + roundedCorner * dirY2}
                  Q 16 50 ${16 - roundedCorner * dirX2} ${50 - roundedCorner * dirY2}
                ...
                ? `M ${24 + roundedCorner / 3}, 0
                  ...
                  Q 84 50 ${84 - roundedCorner * dirX1} ${50 + roundedCorner * dirY1}
                  L ${74 + roundedCorner * dirX1}, ${100 - roundedCorner * dirY1}
                  Q 74 100 ${74 - roundedCorner} 100
                  L ${24 + roundedCorner / 3}, 100
                  Q 24 100 ${24 + roundedCorner * dirX2} ${100 - roundedCorner * dirY2}
                  L ${40 - roundedCorner * dirX2}, ${50 + roundedCorner * dirY2}
                  Q 40 50 ${40 - roundedCorner * dirX2}, ${50 - roundedCorner * dirY2}
