...
export default class EnzymesGroups extends React.Component {
    ...
    filterList() {
        let string = this.refs.enzymeField.value;
        let currentEnzymesList = this.props.currentEnzymesList;
        ...
        if (string && string.length > 0) {
            ...
            this.setState({ currentEnzymesList });
        }
    }
    ...
    render() {
        ...
        let currentEnzymesList = this.state.currentEnzymesList;
        // #cceeff
        let selectedStyle = {
        ...
        return (
            <div>
                ...
                <RaisedButton
                    ...
                    onTouchTap={function () {
                        signals.editUserEnzymes({currentUserList: currentUserEnzymesList,
                            currentEnzymesList, action: "add all"});
                    }}
                    />
            </div>
        );
